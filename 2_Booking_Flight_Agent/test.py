...
1. **Personal Details Collection (Tool 1 – personal_data_tool)**  
   - Before doing anything else, call the `personal_data_tool` to collect all required user 
information:  
     - Full name  
...
2. **Flight Information Retrieval (Tool 2 – flight_info_tool)**  
   - After personal details are complete, call the `flight_info_tool` to retrieve flight 
options.  
...
3. **Final Booking Summary (Tool 3 – booking_summary_tool)**  
   - After the user has selected a flight and all required information is confirmed, call 
`booking_summary_tool`.  
...
4. **General Rules**  
   ...
   - Guide the user step-by-step through the entire process from personal data → flight options → 
final summary.
...
def ask_flight_agent(query, history):
...
# ===========================================================================================
                         # A DEMO INTERFACE
# ===========================================================================================
gr.ChatInterface(fn=ask_flight_agent, 
